...
func Test_CompletedSubOrchestration(t *testing.T) {
	...
	s := backend.NewOrchestrationRuntimeState("abc", []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("Child", "child_id", "1.0.0", nil, parentInfo, nil),
	})
...
func Test_RuntimeState_ContinueAsNew(t *testing.T) {
	...
	state := backend.NewOrchestrationRuntimeState(api.InstanceID(iid), []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent(expectedName, iid, "1.0.0", nil, nil, nil),
	})
...
func Test_CreateTimer(t *testing.T) {
	...
	s := backend.NewOrchestrationRuntimeState(iid, []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("MyOrchestration", iid, "1.0.0", nil, nil, nil),
	})
...
func Test_ScheduleTask(t *testing.T) {
	...
	state := backend.NewOrchestrationRuntimeState(iid, []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("MyOrchestration", iid, "1.0.0", wrapperspb.String(expectedInput), nil, nil),
	})
...
func Test_CreateSubOrchestration(t *testing.T) {
	...
	state := backend.NewOrchestrationRuntimeState(api.InstanceID(iid), []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("Parent", iid, "1.0.0", nil, nil, nil),
	})
...
func Test_SendEvent(t *testing.T) {
	...
	s := backend.NewOrchestrationRuntimeState("abc", []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("MyOrchestration", "abc", "1.0.0", wrapperspb.String(expectedInput), nil, nil),
	})
...
func Test_StateIsValid(t *testing.T) {
	...
	s = backend.NewOrchestrationRuntimeState("abc", []*protos.HistoryEvent{
		helpers.NewExecutionStartedEvent("MyOrchestration", "abc", "1.0.0", nil, nil, nil),
	})
	assert.True(t, s.IsValid())
	s = backend.NewOrchestrationRuntimeState("abc", []*protos.HistoryEvent{
...
func Test_DuplicateEvents(t *testing.T) {
	s := backend.NewOrchestrationRuntimeState("abc", []*protos.HistoryEvent{})
	if err := s.AddEvent(helpers.NewExecutionStartedEvent("MyOrchestration", "abc", "1.0.0", nil, nil, nil)); assert.NoError(t, err) {
		err = s.AddEvent(helpers.NewExecutionStartedEvent("MyOrchestration", "abc", "1.0.0", nil, nil, nil))
