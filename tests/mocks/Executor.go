...
func (_m *Executor) ExecuteOrchestrator(ctx context.Context, iid api.InstanceID, version string, oldEvents []*protos.HistoryEvent, newEvents []*protos.HistoryEvent) (*backend.ExecutionResults, error) {
	ret := _m.Called(ctx, iid, version, oldEvents, newEvents)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, api.InstanceID, string, []*protos.HistoryEvent, []*protos.HistoryEvent) (*backend.ExecutionResults, error)); ok {
		return rf(ctx, iid, version, oldEvents, newEvents)
	}
	if rf, ok := ret.Get(0).(func(context.Context, api.InstanceID, string, []*protos.HistoryEvent, []*protos.HistoryEvent) *backend.ExecutionResults); ok {
		r0 = rf(ctx, iid, version, oldEvents, newEvents)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, api.InstanceID, string, []*protos.HistoryEvent, []*protos.HistoryEvent) error); ok {
		r1 = rf(ctx, iid, version, oldEvents, newEvents)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *Executor_Expecter) ExecuteOrchestrator(ctx interface{}, iid interface{}, version string, oldEvents interface{}, newEvents interface{}) *Executor_ExecuteOrchestrator_Call {
	return &Executor_ExecuteOrchestrator_Call{Call: _e.mock.On("ExecuteOrchestrator", ctx, iid, version, oldEvents, newEvents)}
}

func (_c *Executor_ExecuteOrchestrator_Call) Run(run func(ctx context.Context, iid api.InstanceID, version string, oldEvents []*protos.HistoryEvent, newEvents []*protos.HistoryEvent)) *Executor_ExecuteOrchestrator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(api.InstanceID), args[2].(string), args[3].([]*protos.HistoryEvent), args[4].([]*protos.HistoryEvent))
	})
	return _c
}
...
func (_c *Executor_ExecuteOrchestrator_Call) RunAndReturn(run func(context.Context, api.InstanceID, string, []*protos.HistoryEvent, []*protos.HistoryEvent) (*backend.ExecutionResults, error)) *Executor_ExecuteOrchestrator_Call {
	_c.Call.Return(run)
	return _c
}
