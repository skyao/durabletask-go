...
func (te *taskExecutor) ExecuteOrchestrator(ctx context.Context, id api.InstanceID, version string,
	oldEvents []*protos.HistoryEvent, newEvents []*protos.HistoryEvent) (*backend.ExecutionResults, error) {
